  ...
  return [
    {
      ...
      type: "date", // The type of the Property.  Options are: "boolean", "date", "email", "float", "integer", "phoneNumber", "string", "url"
      ...
      options: {
        column: "START_DATE", // The column to use for this Property - e.g. `column: "first_name"`
